#!/usr/bin/env bash
# cleanup-worktrees.sh — baileys-client (library) variant
#
# Adapted from standards/templates. No Postgres DB to drop — just remove the
# worktree, optionally delete the branch (only if merged into main, or --force).
#
